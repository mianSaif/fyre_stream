                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col">
                                ...
                                <div class="dropdown-menu mt-n5 dropdown-menu-right">
                                    ...
                                    <form action="{{ route('timelinepost.deleteComment', ['comment' => $a->id]) }}" method="post">
                                        @method('delete')
                                        @csrf
                        ...
                        <div class="row no-gutters my-2">
                            ...
                            <div class="col mr-3">
                                <form method="post" action="{{route('timelinepost.storeComment', ['id' => $a->id])}}">
                                    @csrf
                                    <input type="text" class="form-control" placeholder="Write a comment..." style="border-radius: 20px;" name="comment" id="comment">
                                ...
                                <div class="col">
                                    <div class="d-flex justify-content-between">
                                        <div class="px-3 py-2 d-inline-block" style="background-color: #F0F2F5; border-radius: 15px;">
                                            <p class="mb-0"><b>{{$c->user->first_name}} {{$c->user->last_name}}</b></p>
